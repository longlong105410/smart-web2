...
<div class="wrap-content">
    <div class="panel no-border">
        <div class="panel-search">
              <form class="form-inline cnoj-entry-submit" id="search-form-position" method="post" role="form" action="role/positionlist" target="#role-position-tab">
                  ...
                  <div class="form-group p-r-10">
				    ...
				    <input type="text" class="form-control input-form-sm-control" id="search-input02" name="name" placeholder="请输入名称" value="${searchParam.name }"/>
				  </div>
		...
		<cnoj:table smartResp="${smartResp }" headers="名称,所属机构" isCheckbox="1" isRowSelected="1" page="${pageParam }" currentUri="${currentUri }" 
