...
<%@taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
	<!-- EasyUI 插件-->
	<link href="${pageContext.request.contextPath}/plugins/easyui/themes/default/linkbutton.css" rel="stylesheet" />
	...
	<link href="${pageContext.request.contextPath}/plugins/easyui/themes/icon.css" rel="stylesheet" />
	...
	<script src="${pageContext.request.contextPath}/plugins/jqueryFileUpload/js/locale.js" type="text/javascript" ></script>
   ...
   <div class="header">
      <div class="navbar-brand p-l-15">
        <div class="p-t-8"><a href="index"><img style="margin:0 5px 6px 0;" src="images/logo_head.png"/>${project.name }</a></div>
      </div>
      ...
      <div class="navbar-nar-right p-t-5"  >
          <ul class="navbar-menu" >
            <li>
             ...
             <!-- <li>
                <a id="app-download" href="javascript:void(0)"><span class="glyphicon glyphicon-download-alt"></span> 手机客户端下载</a>
             </li> -->
          </ul>
      </div>  
   </div><!-- header -->
   <div class="header-bottom header-body-dividing">
      <div class="container-fluid">
	      <div class="row">
	         <div class="col-sm-3 col user-info line-ell"><i class="glyphicon glyphicon-user"></i> &nbsp;<strong>${userInfo.fullName}</strong> &nbsp;
	         ...
	         <div class="col-sm-3 col not-msg-prompt"><i class="glyphicon glyphicon-t-2 glyphicon-envelope"></i> &nbsp;<span id="no-read-prompt" class="color-red roll-prompt"></span></div>
	         <div class="separate left"></div>
	         <div class="col-sm-3 col color-green text-bold"><span id="show-date"></span><!--  &nbsp;<span id="show-hours"></span>:<span id="show-minute"></span>:<span id="show-seconds-twinkle"></span>--></div>
	         <div class="separate left"></div>
	         <div class="navbar-nar-right p-t-5 p-r-5"> 
	            <ul class="header-bottom-menu">
	               ...
	               <li><a href="#" class="cnoj-open-blank" data-uri="showPage/base_user_changePwd" data-title="修改密码" data-width="520"><i class="glyphicon glyphicon-t-2 glyphicon-pencil"></i>&nbsp;修改密码</a></li>
	            </ul>
	         </div>
	      </div>
      </div>
  ...
  var isActive = false;
   $(document).ready(function(){
	   $("#change-pwd").click(function(){
	       ...
	       if(trim(uri) != '') {
	          BootstrapDialogUtil.loadUriDialog("修改密码",uri,"520","#fff");
	       }
	       return false;
	   });
	 //下载手机客户端
	   $("#app-download").click(function(){
	   	    var uri="showPage/form_redHeadSelect";
	   		BootstrapDialogUtil.dialog("手机客户端下载","#app-download-div",400,"#fff",false);
	   		return false;
	   });
	 
	 //提醒信息
	 rollPrompt("#no-read-prompt");
	 setInterval("rollPrompt('#no-read-prompt')", 1000*60*2);
   });*/
</script>