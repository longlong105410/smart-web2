<%@ page language="java" import="java.util.*" pageEncoding="UTF-8"%>
 <div class="wrap-content-dialog">
        <form class="form-horizontal" role="form" id="form-add" action="form/helper/save.json">
            <div class="form-group m-b-10">
			    <label for="input01" class="col-sm-1 control-label">标题</label>
			    <div class="col-sm-11 p-l-0">
			      <input type="text" class="form-control require" name="title" data-label-name="标题" id="input01" />
			    </div>
			</div>
			<div class="form-group m-b-10">
