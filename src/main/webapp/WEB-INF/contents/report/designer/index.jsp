		          ...
		          <table class="table">
		              <tbody>
		                  <tr>
		                      ...
		                      <td>
		                          <input type="text" name="name" class="form-control" id="report-name" placeholder="请输入报表名称" />
		                      </td>
                              ...
                              <td>
                                  <select class="form-control cnoj-select select-form-control" name="isImport" data-uri="dict/item/YES_OR_NO.json" data-default-value="${objBean.isImport }" >
                                  </select>
                              </td>
		                  </tr>
		              </tbody>
