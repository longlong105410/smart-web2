...
public class ObjectTreeHelper {
	...
	protected List<Object> getChild(List<Object> lists, Object obj) {
		...
		for (Object objTmp : lists) {
			if (StringUtil.handNull(((Object[]) objTmp)[1]).equals(
				...
				if (childs != null
						&& childs.size() != 0
						&& Double.parseDouble(StringUtil .handNumNull(((Object[]) objTmp)[2])) >= Double.parseDouble(StringUtil.handNumNull(((Object[]) childs.get(0))[2]))) {
					childs.add(0, objTmp);
				} else {
					childs.add(objTmp);
				}
		...
		if(null != ts && ts.size()>0) {
			roots = new TreeSet<Object>(new Comparator<Object>() {
				...
				public int compare(Object o1, Object o2) {
					int compare = StringUtil.handObj2Integer(((Object[])o1)[2]).compareTo(StringUtil.handObj2Integer(((Object[])o2)[2]));
					if(compare==0) {
						if(StringUtil.handNull(((Object[])o1)[0]).equals(StringUtil.handNull(((Object[])o2)[0]))) {
							compare = 0; 
						} else {
							compare = 1;
						}
	...
	protected Object getParent(List<Object> ts, Object t) {
		...
		for (Object tt : ts) {
			if (StringUtil.handNull(((Object[])tt)[0]).equals(StringUtil.handNull(((Object[])t)[1]))) {
				tmp = tt;
			}
		}
		return tmp;
