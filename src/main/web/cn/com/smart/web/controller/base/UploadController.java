...
public abstract class UploadController extends BaseController {
	 ...
	 * @return 返回上传结果，如果上传成功，则返回结果中包含了文件的信息
	 */
	protected SmartResponse<UploadFileInfo> upload(File file,String contentType,String uploadFileName,String destFileName,String uploadDir) {
		SmartResponse<UploadFileInfo> chRes = new SmartResponse<UploadFileInfo>();
		if(null != file) {
	 ...
	 * @return 返回上传结果，如果上传成功，则返回结果中包含了文件的信息
	 */
	protected SmartResponse<UploadFileInfo> upload(File file,String contentType,String uploadFileName) {
		SmartResponse<UploadFileInfo> chRes = new SmartResponse<UploadFileInfo>();
		if(null != file) {
	 ...
	 * @return 返回上传结果，如果上传成功，则返回结果中包含了文件的信息
	 */
	protected SmartResponse<UploadFileInfo> upload(InputStream inputStream,String contentType,String uploadFileName,long fileSize,String destFileName,String uploadDir) {
		SmartResponse<UploadFileInfo> chRes = new SmartResponse<UploadFileInfo>();
		if(null != inputStream) {
	 ...
	 * @return 返回上传结果，如果上传成功，则返回结果中包含了文件的信息
	 */
	protected SmartResponse<UploadFileInfo> upload(InputStream inputStream,String contentType,String uploadFileName,long fileSize) {
		SmartResponse<UploadFileInfo> chRes = new SmartResponse<UploadFileInfo>();
		if(null != inputStream) {
